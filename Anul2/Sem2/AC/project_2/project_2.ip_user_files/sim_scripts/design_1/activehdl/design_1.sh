...
#
# Script generated by Vivado on Sat Apr 19 16:52:50 +0300 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Facultate/Anul2/Anul2/Sem2/AC/project_2/project_2.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
